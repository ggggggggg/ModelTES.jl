...
R(I, T, RIT::ShankRIT) = RIT.Rn/2*(1+tanh.((T-RIT.Tc+(max.(I,0.0)/RIT.A).^(2/3))/(2*log(2)*RIT.Tw)))
...
Tc=0.094u"mK"; Tbath = 0.075u"mK"
R0 = 1.64u"mΩ"; Rl = 0.35u"mΩ"; Rn = 8.2u"mΩ"; Rpara=0.0u"mΩ"
n=3.15; G = 100.0u"pW/K"; C = 0.1u"pJ/K"
